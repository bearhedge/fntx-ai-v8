    ...
    <div className="h-screen flex flex-col bg-white relative">
      ...
      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full min-h-0">
        <div className="flex-1 overflow-y-auto p-8 pb-4">
          {messages.length === 1 ? (
            // Welcome state - removed FNTX logo
            ...
            // Messages view - aligned to the left to match the logo position
            <div className="space-y-6 ml-0">
              {messages.map((message, index) => {
                // Show FNTX logo above all AI messages (including the first one)
