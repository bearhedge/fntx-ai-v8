              ...
              <div className="px-6 pb-6">
                {activeTab === 'performance' && <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-4 gap-6">
                      {performanceMetrics.map((metric, index) => <div key={metric.label} className="bg-gray-100 border border-gray-200 rounded-lg p-3 hover:bg-gray-700 group-hover:text-white transition-all duration-200 cursor-pointer relative w-full h-32" onClick={() => handleCardClick(metric.label)}>
                          {/* Front Side */}
