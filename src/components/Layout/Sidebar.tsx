...
const previousChats = [
  { id: 1, title: 'Responding to SparkBrainz ...', date: 'Thu', active: false },
  { id: 2, title: 'Hello', date: 'Sat', active: true },
  { id: 3, title: 'AI Chatbot for Blockchain-B...', date: '5/21', active: false },
];
    ...
    <div className="w-80 bg-gray-50 border-r border-gray-200 flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-lg font-semibold text-gray-700">manus</span>
        </div>
      </div>
