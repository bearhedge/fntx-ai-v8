...
export const WithdrawalTab: React.FC<WithdrawalTabProps> = ({
  ...
  const handleWithdrawal = () => {
    ...
    console.log('Processing withdrawal:', { amount, destinationId: selectedDestination });
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-3 gap-8 mb-6">
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div className="bg-gray-600 h-2 rounded-full" style={{ width: `${(availableBalance / totalPortfolioValue) * 100}%` }}></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div className="bg-gray-400 h-2 rounded-full" style={{ width: `${(lockedFunds / totalPortfolioValue) * 100}%` }}></div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8">
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
              <div className="bg-gray-500 h-2 rounded-full" style={{ width: `${(pendingRelease / totalPortfolioValue) * 100}%` }}></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
              <div className="bg-gray-700 h-2 rounded-full" style={{ width: `${(totalWithdrawnYTD / totalPortfolioValue) * 100}%` }}></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  name="amountType"
                  value="recommended"
                  checked={amountType === 'recommended'}
                  onChange={(e) => setAmountType(e.target.value as 'recommended' | 'custom')}
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    disabled={amountType === 'recommended'}
                  />
                </div>
              </label>
            </div>
